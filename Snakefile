...
#         model = "model_test_grid_search_8/final/model_100K_0.007_20.pth",
#         validation_csv = expand("predictions_dfs/{checkpoint}.csv", checkpoint = IDS),#expand("sample.{num}.dev.csv", num = SAMPLES)
#     output:
#         predictions = expand("predictions_initial_test_8_test_{checkpoint}.csv", checkpoint = IDS)
#         #predictions_initial = "predictions_initial_test_8_test.csv"
#     shell:
#         """
